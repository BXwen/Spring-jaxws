 ...
 * generated in the com.db.cis.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _Say_QNAME = new QName("http://ws.db.com/", "say");
    private final static QName _SayResponse_QNAME = new QName("http://ws.db.com/", "sayResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.db.cis.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.db.com/", name = "say")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.db.com/", name = "sayResponse")
